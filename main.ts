...
/*###################################################################################################################################	
 ...
 ###################################################################################################################################*/	
	...
	setPwm(6, 0, value);    //channel LED, ?,PWM value (on-off)
    }	
...
namespace mbit_Sensor {
    ...
    export enum enVoice {
        //% blockId="Voice" block="włacz - sound"
        Voice = 0,
...
namespace mbit_Music {
    export enum enBuzzer {
        ...
        //% blockId="NoBeep" block="wyłącz"
        NoBeep = 0,
        //% blockId="Beep" block="włącz"
        Beep
    }
